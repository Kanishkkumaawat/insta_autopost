...
WARMUP_DAY_PLANS: Dict[int, List[Dict[str, Any]]] = {
    1: [
        ...
        {"id": "day1_delete_archive", "label": "Delete/archive dead posts (manual)", "manual": True, "target": 1, "category": "profile"},
        {"id": "day1_follow", "label": "Follow 10–15 niche accounts", "manual": True, "target": 12, "category": "engage"},
        {"id": "day1_watch_reels", "label": "Watch 20–30 reels fully", "manual": True, "target": 25, "category": "engage"},
    ...
    2: [
        {"id": "day2_niche_search", "label": "Search niche keyword, watch top reels", "manual": True, "target": 1, "category": "engage"},
        {"id": "day2_rewatch", "label": "Rewatch 3–4 reels", "manual": True, "target": 4, "category": "engage"},
        ...
        {"id": "day2_share_story", "label": "Share 2 reels to story", "manual": True, "target": 2, "category": "story"},
    ],
    3: [
        {"id": "day3_follow", "label": "Follow 5–8 niche accounts", "manual": True, "target": 6, "category": "engage"},
        {"id": "day3_reply_story", "label": "Reply to 2–3 story polls/questions", "manual": True, "target": 3, "category": "dm"},
        {"id": "day3_story_dm", "label": "Send 2 genuine DMs (reply to stories)", "manual": True, "target": 2, "category": "dm"},
